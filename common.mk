...
BT := javax.btobex
BT += libattrib_static
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/google/seed
...
PRODUCT_COPY_FILES += \
    device/google/seed/gps/sec_config:system/etc/sec_config
